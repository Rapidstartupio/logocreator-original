...
Primary color is ${data.selectedPrimaryColor.toLowerCase()} and background color is ${data.selectedBackgroundColor.toLowerCase()}${data.selectedLayout !== "Icon" ? `, the company name is ${data.companyName}, make sure to include the company name in the logo` : ""}. ${data.additionalInfo ? `Additional info: ${data.additionalInfo}` : ""}`;
